...
const productos = [
	...
	},
	{
		id: 4,
		nombre: 'Herramientas',
		descripcion: 'Potencia y calidad en tus manos.',
		precio: 'Consulta en WhatsApp',
		imagenes: [
			'/herramientas-1.jpg',
			'/herramientas-2.jpg',
			'/herramientas-3.jpg',
	...
	{
		id: 5,
		nombre: 'Termos stanley',
		descripcion: 'Conservan la temperatura por horas, resisten golpes y acompañan cada aventura. Ya sea en la obra, la ruta o el parque, Stanley es sinónimo de confianza.',
		precio: 'Consulta en WhatsApp',
		imagenes: [
			'/producto5-1.jpg',
			'/producto5-2.jpg',
	...
	return (
		<div className="contenedor-principal">
			...
			<div className="whatsapp-flotante">
				<a
					href="https://wa.me/5491138426645?text=Hola!%20Quiero%20realizar%20una%20consulta"
					target="_blank"
					rel="noopener noreferrer"
